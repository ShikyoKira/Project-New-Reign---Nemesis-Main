...
namespace nemesis
{
    ...
    struct HkxBehaviorFile : public nemesis::File
    {
    private:
        struct BhvSlctInfo
        {
        ...
        private:
            ...
            nemesis::HkxBehaviorFile& hostref;
            ...
            USet<const nemesis::TemplateCategory*> templateclasses;

            USet<const nemesis::TemplateCategory*>& GetTemplateCategoryes();
        ...
        public:
            Parser(nemesis::HkxBehaviorFile& host, const VecStr& behaviorpriotiy);
            ~Parser();
        ...
        {
        private:
            using funcptr = void (nemesis::HkxBehaviorFile::Exporter::*)(const nemesis::Line&);
        ...
        public:
            Exporter(const HkxBehaviorFile& host, VecNstr& storeline);
        ...
        SPtr<nemesis::HkxEventList> events;
        SPtr<nemesis::HkxVariableList> variables;
        SPtr<nemesis::HkxAttributeList> attibutes;
        ...
        nemesis::HkxBehaviorFile::Node* TryGetNodeExist(const nemesis::Patch& patch);
