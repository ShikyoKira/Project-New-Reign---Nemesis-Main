...
void NemesisEngine::setupUi()
{
	if (this->objectName().isEmpty())
		this->setObjectName(QStringLiteral("NemesisMainGUIClass"));
	this->resize(528, 782);
	...
	ui.modView->setEditTriggers(QAbstractItemView::EditKeyPressed | QAbstractItemView::SelectedClicked | QAbstractItemView::DoubleClicked);
	...
	QObject::connect(ui.modView, SIGNAL(dropModelUpdate(bool)), ui.modView->model(), SLOT(dropModelUpdate(bool)));
