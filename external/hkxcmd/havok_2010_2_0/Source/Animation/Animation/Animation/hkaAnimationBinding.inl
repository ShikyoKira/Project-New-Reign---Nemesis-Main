...
{
	// <todo, COM-629> simple array -> hkArray
...
HK_FORCE_INLINE hkaAnimationBinding::hkaAnimationBinding( hkFinishLoadedObjectFlag flag )
	: hkReferencedObject(flag), m_originalSkeletonName(flag), m_animation(flag), m_transformTrackToBoneIndices( flag ), m_floatTrackToFloatSlotIndices( flag )
{
}
