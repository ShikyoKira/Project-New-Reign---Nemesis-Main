...
{
   HK_DECLARE_NONVIRTUAL_CLASS_ALLOCATOR( HK_MEMORY_CLASS_BEHAVIOR_RUNTIME, hkbCompiledExpressionSetToken );
   HK_DECLARE_REFLECTION();

   HK_FORCE_INLINE hkbCompiledExpressionSetToken(void) {}
   enum TokenType
   {
      TOKEN_TYPE_NONE = 0,
