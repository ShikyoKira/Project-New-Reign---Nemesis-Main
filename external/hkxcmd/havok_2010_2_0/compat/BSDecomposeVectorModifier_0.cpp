...
const hkClass BSDecomposeVectorModifierClass(
    "BSDecomposeVectorModifier",
    &hkbModifierClass, // parent
    sizeof(BSDecomposeVectorModifier),
    HK_NULL, 0, // interfaces
    HK_NULL, 0, // enums
    reinterpret_cast<const hkClassMember*>(BSDecomposeVectorModifierClass_Members), HK_COUNT_OF(BSDecomposeVectorModifierClass_Members),
    HK_NULL, // defaults
    HK_NULL, // attributes
    0, // flags
    0 // version
