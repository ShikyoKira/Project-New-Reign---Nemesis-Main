...
#include "Nemesis_Core_Engine/include/Utilities/SharableWrapper.h"
...
namespace nemesis
{
    ...
    public:
        ...
        bool operator==(const RawChar* str) const noexcept;
        bool operator==(const RawType& str) const noexcept;
        bool operator==(const nemesis::Line& line) const noexcept;
        bool operator!=(const RawChar* str) const noexcept;
        bool operator!=(const RawType& str) const noexcept;
        bool operator!=(const nemesis::Line& line) const noexcept;
        RawType operator+(const RawChar* str) const noexcept;
        RawType operator+(const RawType& str) const noexcept;
        nemesis::Line operator+(const nemesis::Line& str) const noexcept;
    ...
    public:
        ...
        RawChar& operator[](size_t index) noexcept;
        const RawChar& operator[](size_t index) const noexcept;
        bool operator==(const RawChar* wstr) const noexcept;
        bool operator==(const RawType& wstr) const noexcept;
        bool operator==(const nemesis::Wline& wline) const noexcept;
        bool operator!=(const RawChar* wstr) const noexcept;
        bool operator!=(const RawType& wstr) const noexcept;
        bool operator!=(const nemesis::Wline& wline) const noexcept;
        RawType operator+(const RawChar* wstr) const noexcept;
        RawType operator+(const RawType& wstr) const noexcept;
        nemesis::Wline operator+(const nemesis::Wline& wstr) const noexcept;
