...
namespace nemesis
{
    struct hkbLookAtModifierInternalState : nemesis::hkReferencedObject
    {
        static constexpr nemesis::hkClass Class{0xa14caba6,
    ...
    constexpr nemesis::hkClass nemesis::hkbLookAtModifierInternalState::Class;
}
