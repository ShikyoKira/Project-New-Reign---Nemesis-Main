...
namespace nemesis
{
    struct hkbHandIkDriverInfoHand : nemesis::HavokObject
    {
    ...
    private:
        REGISTER_HAVOK_POINTER_HEADER(hkbHandIkDriverInfoHand);
    ...
    public:
        hkbHandIkDriverInfoHand() noexcept;
    ...
    constexpr nemesis::hkClass nemesis::hkbHandIkDriverInfoHand::Class;
}
