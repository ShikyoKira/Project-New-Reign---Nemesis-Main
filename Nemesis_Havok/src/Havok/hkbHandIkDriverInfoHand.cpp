...
REGISTER_HAVOK_POINTER_SOURCE(hkbHandIkDriverInfoHand,
                              [](nemesis::HavokVersion version)
                              { return &nemesis::hkbHandIkDriverInfoHand::Class; });

nemesis::hkbHandIkDriverInfoHand::hkbHandIkDriverInfoHand() noexcept
    : nemesis::HavokObject(Class.GetSignature())
{
}

const nemesis::hkClass* nemesis::hkbHandIkDriverInfoHand::GetClass(nemesis::HavokVersion version) const
{
    return &Class;
}

void nemesis::hkbHandIkDriverInfoHand::SerializeTo(nemesis::Serializer& serializer) const
{
    serializer.WriteValue("elbowAxisLS", m_elbowAxisLS);           // offset: 0/0 size: 16/16 align: 16/16
    serializer.WriteValue("backHandNormalLS", m_backHandNormalLS); // offset: 16/16 size: 16/16 align: 16/16
    serializer.WriteValue("handOffsetLS", m_handOffsetLS);         // offset: 32/32 size: 16/16 align: 16/16
    serializer.WriteValue("handOrienationOffsetLS",
...
void nemesis::hkbHandIkDriverInfoHand::DeserializeFrom(nemesis::Deserializer& deserializer)
{
    deserializer.ReadValue("elbowAxisLS", m_elbowAxisLS);           // offset: 0/0 size: 16/16 align: 16/16
    deserializer.ReadValue("backHandNormalLS", m_backHandNormalLS); // offset: 16/16 size: 16/16 align: 16/16
    deserializer.ReadValue("handOffsetLS", m_handOffsetLS);         // offset: 32/32 size: 16/16 align: 16/16
    deserializer.ReadValue("handOrienationOffsetLS",
                           m_handOrienationOffsetLS); // offset: 48/48 size: 16/16 align: 16/16
