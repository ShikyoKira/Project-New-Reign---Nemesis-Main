...
nemesis::hkbComputeRotationToTargetModifierInternalState::
...
const nemesis::hkClass* nemesis::hkbComputeRotationToTargetModifierInternalState::GetClass(nemesis::HavokVersion version) const
{
    return &Class;
}

void nemesis::hkbComputeRotationToTargetModifierInternalState::SerializeTo(
...
void nemesis::hkbComputeRotationToTargetModifierInternalState::DeserializeFrom(
