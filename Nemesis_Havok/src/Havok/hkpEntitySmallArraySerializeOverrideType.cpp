...
REGISTER_HAVOK_POINTER_SOURCE(hkpEntitySmallArraySerializeOverrideType,
                              [](nemesis::HavokVersion version)
                              { return &nemesis::hkpEntitySmallArraySerializeOverrideType::Class; });

nemesis::hkpEntitySmallArraySerializeOverrideType::hkpEntitySmallArraySerializeOverrideType() noexcept
    : nemesis::HavokObject(Class.GetSignature())
{
}

const nemesis::hkClass* nemesis::hkpEntitySmallArraySerializeOverrideType::GetClass(nemesis::HavokVersion version) const
{
    return &Class;
}

void nemesis::hkpEntitySmallArraySerializeOverrideType::SerializeTo(nemesis::Serializer& serializer) const
{
...
void nemesis::hkpEntitySmallArraySerializeOverrideType::DeserializeFrom(nemesis::Deserializer& deserializer)
{
