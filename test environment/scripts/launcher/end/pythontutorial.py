...
if my_file.is_file():
	...
	if fnis.is_file():
		...
		shutil.copy2('scripts/launcher/end/XPMSE/script1', '../scripts/FNISVersion.pex')
	
	fnis = Path("../scripts/FNISVersionGenerated.pex")
	
	if fnis.is_file():
		# create FNIS version generated, allowing FNIS based mods hook to a proxy
		shutil.copy2('scripts/launcher/end/XPMSE/script2', '../scripts/FNISVersionGenerated.pex')
